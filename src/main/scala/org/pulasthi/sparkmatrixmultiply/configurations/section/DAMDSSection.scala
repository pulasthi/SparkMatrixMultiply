package org.pulasthi.sparkmatrixmultiply.configurations.section
...
class DAMDSSection  (configurationFilePath: String){
  ...
  def toString(centerAligned: Boolean): String ={
    ...
    val args: Array[Any] = Array(distanceMatrixFile,
                                  ...
                                  isBigEndian,
                                  isMemoryMapped)
    //Optional[Integer] maxLength = params.maxBy(_.length)

    return "Still need to implement the print method";
  }
}
